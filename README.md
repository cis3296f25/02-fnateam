...
- There are 5 mascots and each starts in a specific rooms :
   1. Hooter, Gritty and Philly Phanatic starting at the lounge
   2. Phang starts in the utilty room
   3. Franklin starts in the BallCart
...
- To defend yourself, there are 2 methods:
   1. In the office, there are 2 doors and 1 vent where you can use the flashlight to scare off the mascots at the door/vent
   2. Each rooms you see on the camera have a seal door feature that prevents the mascot from entering or leaving the room.
...
- Finally, there is a power system where the actions you do such as opening the camera, sealing the rooms, or flashing the doors/vent will take a certain percentage of the power.
   1. When the power reaches 0, it will autamatically go into a recharge state, where you are essentially a sitting duck.
